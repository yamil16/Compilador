...
public class Main {
			...
			public static void main (String [] args) {				
				...
				listaTerceto= new ArrayList<Terceto>();
						...
						//	arc.append("tokens: "+"\r\n");
							...
							Parser parser = new Parser("C:\\Users\\Yamil\\workspace\\Compiladores_2016_v4\\src\\tp11.txt");
							parser.run();			
							String auxi = "";
	...
	//							  System.out.println(clave.toString());
							...
							arc.append( "Tercetos detectados: " + "\r\n");
							
							try{
								int i = 0;
								for (int j = 0; j < listaTerceto.size(); j++) {
									Terceto auxTerceto2 = listaTerceto.get(j);
									System.out.println("posicion "+j+" "+auxTerceto2.getLexema());
							...
							if (count == 0){
								try {
									...
									System.out.println("Null el GeneradorAssembler");
									eg.printStackTrace();
